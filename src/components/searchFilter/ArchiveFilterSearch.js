...
export default function ArchiveFilterSearch({ archiveData,setArchiveData, archiveDataBkp}) {
  ...
  return (
    ...
    </View>
    {
        ...
        <Button icon={sortDirections.id == 'ascending' ? 'arrow-up-thick' : 'arrow-down-thick'} mode="contained-tonal" buttonColor={ activeFilter == 'id' ? AppStyles.color.tint : '' } contentStyle={styles.buttonContainer} labelStyle={activeFilter == 'id'? styles.filterButtonActive  :styles.filterButton }  onPress={() =>{ handleSort('id'); setActiveFilter('id')} }>Id</Button>
            ...
            <Button icon={sortDirections.end_date == 'ascending' ? 'arrow-up-thick' : 'arrow-down-thick'}  mode="contained-tonal" buttonColor={ activeFilter == 'end' ? AppStyles.color.tint : '' } contentStyle={styles.buttonContainer} labelStyle={activeFilter == 'end'? styles.filterButtonActive  :styles.filterButton } onPress={() =>{ handleSort('end_date'); setActiveFilter('end')}}>End Date</Button>
            <Button icon={sortDirections.status == 'ascending' ? 'arrow-up-thick' : 'arrow-down-thick'}  mode="contained-tonal" buttonColor={ activeFilter == 'status' ? AppStyles.color.tint : '' } contentStyle={styles.buttonContainer} labelStyle={activeFilter == 'status'? styles.filterButtonActive  :styles.filterButton } onPress={() =>{ handleSort('status'); setActiveFilter('status')}}>End Date</Button>
        </View>
    </View>
        )
    }
